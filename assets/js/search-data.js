...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "These are some of the projects I have worked on or am working on",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-reu-research-ai-for-high-temperature-composites",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-aiaa-paper-autonomous-power-line-retrieval-drone",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-smart-watch-drone",
          title: 'Smart Watch Drone',
          description: "Concept project exploring a foldable, wearable quadcopter integrated into a smartwatch form factor",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%4B%61%72%74%68%69%6B%6B%61%6E%6E%61%6E%32%30%32%30@%79%61%68%6F%6F.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        section: 'Socials',
        handler: () => {
          window.open("https://instagram.com/carthiccannon", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/https://www.linkedin.com/in/karthik-kannan-b24014208/# your LinkedIn user name", "_blank");
        },
      },{
      id: 'light-theme',
